	...
	return (
		<form id="rep-form" onSubmit={handleSubmit}>
			<div className="field-container">
				<label htmlFor="productLink">Product Line</label>
				<select className="field" name="productLine" value={fields.productLine} onChange={handleChange} required>
					<option value="">Select</option>
					<option value="Ancillary Products">Ancillary Products</option>
					<option value="Flow Measurement">Flow Measurement</option>
					<option value="Heat Transfer">Heat Transfer</option>
					<option value="Hot Water">Hot Water</option>
					<option value="Humidification">Humidification</option>
					<option value="Pressure & Temperature / Control Valves">Pressure & Temperature / Control Valves</option>
					<option value="Service">Service</option>
					<option value="Smart Product">Smart Product</option>
					<option value="Steam & Condensate">Steam & Condensate</option>
				</select>
			</div>
			<div className="field-container">
				...
				<select className="field" name="industry" value={fields.industry} onChange={handleChange} required>
					...
					<option value="Chemical Refining">Chemical Refining</option>
			...
			<div className="field-container">
				...
				<select className="field" name="country" value={fields.country} onChange={handleChange} required>
					<option value="">Select</option>
					<option value="US">UNITED STATES</option>
					<option value="AX">AALAND</option>
					...
					<option value="MK">MACEDONIA, FMR YUGOSLAV REPUBLIC OF</option>
